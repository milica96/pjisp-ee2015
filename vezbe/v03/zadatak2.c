/*
    Dat je niz od maksimalno 20 realnih elemenata. Ucitati n elemenata,
...
int main() {
    ...
    // prosli smo kroz ceo niz i pokusavali da trenutni maksimum "oborimo" vecom trenutnom vrednoscu
