/*
Iz ulazne datoteke uèitati niz studenata koji
su položili ispit (indeks, ime, ocena). Koristiti
funkcije, ime ulazne datoteke prihvatiti kroz
argumente komandne linije.
• U izlaznu datoteku "najvisi.txt" ispisati
podatke o studentu sa najvišim prosekom
• U izlaznu datoteku "najnizi.txt" ispisati
podatke o studentu sa najnižim prosekom
• Na standardnom izlazu ispisati proseènu
