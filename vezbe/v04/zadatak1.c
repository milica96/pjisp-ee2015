...
int main() {
    ...
    do {
        ...
        printf("2. Ispisivanje niza\n");
        printf("3. Izracunavanje sume elemenata niza\n");
        printf("4. Izracunavanje srednje vrednosti elemenata niza\n");
        ...
        switch(izbor) {
            ...
            case 2: ispis(niz, n); break;
            case 3: printf("Suma elemenata niza je: %d\n", suma(niz, n)); break;
            case 4: printf("Srednja vrednost elemenata niza je: %.2lf\n", srednja_vrednost(niz, n)); break;
